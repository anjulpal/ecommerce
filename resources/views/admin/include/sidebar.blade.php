                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseUser" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('admin.user.create')}}">Static Navigation</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">Light Sidenav</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsecategory" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('admin.user.categorylist')}}"> index </a>
                                    <a class="nav-link" href="{{route('admin.user.category')}}"> Create </a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsecoupon" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('admin.coupon.couponlist')}}"> index </a>
                                    <a class="nav-link" href="{{route('admin.coupon.form')}}"> Create </a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsesize" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('admin.size.sizelist')}}"> index </a>
                            ...
                            <div class="collapse" id="collapsecolor" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('admin.color.colorlist')}}"> index </a>
                                    <a class="nav-link" href="{{route('admin.color.create')}}"> Create </a>
                                </nav>
                            </div>
